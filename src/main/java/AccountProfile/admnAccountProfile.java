...
public class admnAccountProfile extends JPanel {
    ...
    public admnAccountProfile() {
        ...
        genderLabel.setBounds(530, 440, 250, 28);
        add(genderLabel);

        genderField = new JTextField("Male");
        genderField.setBounds(530, 472, 450, 45);
        genderField.setEditable(false);
        genderField.setBackground(Color.WHITE);
        genderField.setFont(fieldFont);
        genderField.setBorder(BorderFactory.createCompoundBorder(new LineBorder(borderColor, 1, true),BorderFactory.createEmptyBorder(5, 12, 5, 12)));
        add(genderField);
        ...
        postalLabel.setBounds(50, 785, 250, 28);
        add(postalLabel);

        postalField = new JTextField("4024");
        postalField.setBounds(50, 817, 450, 45);
        ...
        homeLabel.setBounds(530, 785, 250, 28);
        add(homeLabel);

        homeField = new JTextField("Street, Subdivision, Barangay");
        homeField.setBounds(530, 817, 450, 45);
        ...
        cityLabel.setBounds(1010, 785, 250, 28);
        add(cityLabel);

        cityField = new JTextField("City");
        cityField.setBounds(1010, 817, 450, 45);
