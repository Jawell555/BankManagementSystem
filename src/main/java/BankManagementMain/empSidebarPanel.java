...
public class empSidebarPanel extends JPanel {
    ...
    public empSidebarPanel(empSidebarPanelFrame navPage) {
        ...
        btnHome.addActionListener(e -> {
            ...
            btnHome.setForeground(ColorPalette.redPastel);
            navPage.turnPage(new employeeDashboard());
            updateMenuPositions();
        });
        ...
        btnSubTrans.addActionListener(e -> navPage.turnPage(new adminDashboard())); //Paltan niyo nalang yung 'new adminDashboard()'
        btnSubDeposit = createSubButton("Deposit Balance");
        btnSubDeposit.addActionListener(e -> navPage.turnPage(new adminDashboard())); //Paltan niyo nalang yung 'new adminDashboard()'
        btnSubWithdraw = createSubButton("Withdraw Balance");
        btnSubWithdraw.addActionListener(e -> navPage.turnPage(new adminDashboard())); //Paltan niyo nalang yung 'new adminDashboard()'
        ...
        btnBankBalance.addActionListener(e -> {
            ...
            navPage.turnPage(new BankBalance()); 
            updateMenuPositions();
        });
        ...
        btnChangePass.addActionListener(e -> {
            ...
            navPage.turnPage(new adminDashboard()); //Paltan niyo nalang yung 'new adminDashboard()'
            updateMenuPositions();
        });
    ...
    private void updateMenuPositions() {
        ...
        btnManageAcc.setBounds(0, 230, 250, 35);
