...
public class SidebarPanel extends JPanel {
    ...
    public SidebarPanel(SidebarPanelFrame navPage) {
        ...
        btnHome.addActionListener(e -> navPage.turnPage(new Dashboard()));
        ...
        btnBankBalance.addActionListener(e -> navPage.turnPage(new Dashboard())); //Paltan niyo nalang yung 'new Dashboard()'
        btnAccProfile = createMainButton("Account Profile");
        btnAccProfile.addActionListener(e -> navPage.turnPage(new Dashboard())); //Paltan niyo nalang yung 'new Dashboard()'
        btnChangePass = createMainButton("Change Password");
        btnChangePass.addActionListener(e -> navPage.turnPage(new Dashboard())); //Paltan niyo nalang yung 'new Dashboard()'
